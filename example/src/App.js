...
const multidata = [
  [
    ...
    { label: '3:24:06', x: 5, y: -2000 },
    { label: '3:24:07', x: 6, y: 0 },
    { label: '3:24:01', x: 7, y: 0 },
    { label: '3:24:02', x: 8, y: 0 },
    { label: '3:24:03', x: 9, y: 100 },
    { label: '3:24:04', x: 10, y: 0},
    { label: '3:24:05', x: 11, y: 0 },
    { label: '3:24:06', x: 12, y: -2000 },
    { label: '3:24:07', x: 13, y: 0 }
  ],
  [
    { label: '3:24:01', x: 0, y: 0 },
    { label: '3:24:02', x: 1, y: 0 },
