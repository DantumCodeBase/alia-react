...
const multidata = [
  [
    { label: '3:24:01', x: 0, y: 20.37 },
    { label: '3:24:02', x: 1, y: 20.37 },
    { label: '3:24:03', x: 2, y: 20.37 },
    { label: '3:24:04', x: 3, y: 20.37},
    { label: '3:24:05', x: 4, y: 20.37 },
    { label: '3:24:06', x: 5, y: 20.37 },
    { label: '3:24:07', x: 6, y: 20.37 },
    { label: '3:24:01', x: 7, y: 20.37 },
    { label: '3:24:02', x: 8, y: 20.37 },
    { label: '3:24:03', x: 9, y:  20.37},
    { label: '3:24:04', x: 10, y: 20.37},
    { label: '3:24:05', x: 11, y: 20.37 },
    { label: '3:24:06', x: 12, y: 20.37 },
    { label: '3:24:07', x: 13, y: 20.37 }
  ],
  [
